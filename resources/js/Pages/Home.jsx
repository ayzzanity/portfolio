    ...
    return (
        <MainLayout>
            ...
            <div>
                ...
                >
                    <h2 className="text-5xl py-2 font-bold text-primary-600 dark:text-teal-600">
                        Hi, I'm Ayz!
                    </h2>
                    <h3 className="text-3xl py-2 font-medium text-gray-800  dark:text-white">
                    ...
                    <p className="text-md py-5 leading-8 text-gray-800 dark:text-gray-300">
                        ...
                        problems. Specializing in web development with modern
                        technologies.
                    </p>
                    <div className="flex justify-center gap-16 text-5xl text-gray-600 dark:text-gray-300">
                        <AiFillLinkedin />
                        <AiFillGithub />
                    </div>
                    <div className="relative mx-auto mt-16 h-48 w-48 overflow-hidden rounded-full">
                        <img
                            src="https://avatars.githubusercontent.com/u/25843527?v=4"
                            alt="Ayzal Abdulwahid"
                        />
                    </div>
                </section>
                ...
                >
                    <div className="max-w-7xl mx-auto">
                        ...
                        <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-300">
                            Proficient in a wide range of technologies and
                            tools.
                        </p>
                        ...
                        <div className="mt-10 grid grid-cols-2 gap-8 sm:grid-cols-3 lg:grid-cols-4">
                            {skillList.map((skill) => (
                                <div
                                    key={skill.name}
                                    className="col-span-1 flex justify-center py-8 px-8 bg-white dark:bg-gray-700 rounded-lg shadow"
                                >
                ...
                <div className="bg-gray-100 dark:bg-gray-800 py-16 min-h-screen">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center">
                            <h2 className="text-3xl font-extrabold text-gray-900 dark:text-white sm:text-4xl">
                                GitHub Contributions & Featured Projects
                            </h2>
                            <p className="mt-4 text-lg leading-6 text-gray-500 dark:text-gray-300">
                                My coding activity over the past year & some of
                                my recent works
                            </p>
                        </div>
                        ...
                        <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                            {[
                                ...
                                },
                                {
                                    ...
                                    description:
                                        "A collaborative task management system with real-time updates using WebSocket. Features include task assignment, progress tracking, and team chat.",
                                    tech: [
                                        "Vue.js",
                                        "Laravel",
                                        "PostgreSQL",
                                ...
                                },
                                {
                                    ...
                                    description:
                                        "An AI-powered content generation tool that creates unique articles and social media posts using GPT-3 API integration.",
                                    tech: [
                                        "Next.js",
                                        "Python",
                                        "OpenAI API",
                ...
                <footer className="bg-white dark:bg-gray-900 py-4">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        <p className="text-sm text-gray-500 dark:text-gray-400">
                            This portfolio was made possible by React.js,
